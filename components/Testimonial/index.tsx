      ...
      <section>
        ...
        >
          ...
          <div className="swiper testimonial-01 pb-22.5 mb-20">
            ...
            >
              <SwiperSlide>
                <div className="bg-alabaster rounded-3xl dark:shadow-none dark:bg-blacksection dark:border dark:border-strokedark p-9 pt-7.5">
              ...
              <SwiperSlide>
                <div className="bg-alabaster rounded-3xl shadow-solid-9 dark:shadow-none dark:bg-blacksection dark:border dark:border-strokedark p-9 pt-7.5">
                  <div className="flex justify-between border-b border-stroke dark:border-strokedark pb-6 mb-7.5">
                    <div>
                      <h4 className="text-black dark:text-white text-metatitle3 mb-1.5">
                        Jhon Abraham
